  ...
  return (
    <div
      className={`fixed top-0 left-0 ${
        mobileMenu.isOpen ? "bg-black/30 h-screen w-screen" : ""
      } transition-all duration-150 ease-in z-[9]`}
      onClick={(event) => {
    ...
    >
      <div
        className={`fixed md:top-[72px] top-[64px] md:left-0 ${
          mobileMenu.isOpen ? "left-0" : "-left-full"
        } z-10 md:w-[240px] w-[67vw] md:h-[calc(100vh-72px)] h-[calc(100vh-64px)] bg-white border-r-2 border-gray-200 overflow-auto transition-all duration-150 ease-in`}
      >
        <div className="md:pt-10 pt-4 px-4 flex flex-col gap-1 h-full">
          <Link
